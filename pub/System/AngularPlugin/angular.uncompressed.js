/**
 * @license AngularJS v1.3.0-local+sha.cbdaabf
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.cbdaabf/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.cbdaabf',    // all of these placeholder strings will be replaced by grunt's
