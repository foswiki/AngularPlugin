/**
 * @license AngularJS v1.3.8-local+sha.85758ce
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.8-local+sha.85758ce/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.8-local+sha.85758ce',    // all of these placeholder strings will be replaced by grunt's
