/**
 * @license AngularJS v1.3.4-local+sha.bf6a79c
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.4-local+sha.bf6a79c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.4-local+sha.bf6a79c',    // all of these placeholder strings will be replaced by grunt's
