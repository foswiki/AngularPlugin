/**
 * @license AngularJS v1.3.2-local+sha.d906ed3
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.2-local+sha.d906ed3/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.2-local+sha.d906ed3',    // all of these placeholder strings will be replaced by grunt's
